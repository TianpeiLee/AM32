...
void AT_COMP_Init(void)
{
     ...
     SetVTFIRQ( (uint32_t)EXTI2_IRQHandler,EXTI2_IRQn,1,ENABLE  );  //����Ƚ��ж�����Ϊ����ж�
     ...
     SetVTFIRQ( (uint32_t)EXTI3_IRQHandler,EXTI3_IRQn,1,ENABLE  );  //����Ƚ��ж�����Ϊ����ж�
     ...
     SetVTFIRQ( (uint32_t)EXTI4_IRQHandler,EXTI4_IRQn,2,ENABLE  );  //����Ƚ��ж�����Ϊ����ж�
...
void UN_TIM2_Init(void) //IC Timer Init
{
    ...
    */
    ...
    TIM_ICInitStructure.TIM_ICPolarity = TIM_ICPolarity_Rising;       //�������ؿ�ʼ
