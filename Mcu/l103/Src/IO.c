 ...
 *      Author: Alka
 *      modified by TempersLee Step. 26, 2025, for CH32L103
 */
...
//    INPUT_PIN_PORT->CFGLR &= ~mask;
    ...
    IC_TIMER_REGISTER->ATRLR   = 127;                //48MHz / output_timer_prescaler / (63+1)
    out_put = 1;
