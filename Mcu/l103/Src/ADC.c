...
void ADCInit(void)
{
 ...
 #ifdef USE_ADC_INPUT
   ADC_RegularChannelConfig(ADC1, ADC_Channel_0, 1, ADC_SampleTime_CyclesMode3);
   ADC_RegularChannelConfig(ADC1, ADC_Channel_1, 2, ADC_SampleTime_CyclesMode3);
   ADC_RegularChannelConfig(ADC1, ADC_Channel_6, 3, ADC_SampleTime_CyclesMode3);
   ADC_RegularChannelConfig(ADC1, ADC_Channel_TempSensor, 4, ADC_SampleTime_CyclesMode3);
 #else
   ADC_RegularChannelConfig(ADC1, ADC_Channel_1, 1, ADC_SampleTime_CyclesMode3);
   ADC_RegularChannelConfig(ADC1, ADC_Channel_6, 2, ADC_SampleTime_CyclesMode3);
   ADC_RegularChannelConfig(ADC1, ADC_Channel_TempSensor, 3, ADC_SampleTime_CyclesMode3);
 #endif
...
{
    return TempSensor_Volt_To_Temper(ADC_raw_temp * 3300 / 4095);  
}
